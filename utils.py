...
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, LOG_CHANNEL, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION, IS_VERIFY, VERIFY2_URL, VERIFY2_API, PROTECT_CONTENT, HOW_TO_VERIFY, ADMINS, REQ_CHANNEL
        ...
        try:
            await bot.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                   [
                        [ 
                        InlineKeyboardButton('🔺 ꜰᴀꜱᴛ ᴅᴏᴡɴʟᴏᴀᴅ / ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ 🔺', callback_data=f'generate_stream_link:{file.file_id}') #Don't change anything without contacting me @LazyDeveloperr
                        ]
                    ]
                )
            )
